jQuery(document).ready(function ($) {
    ...
    $('#edit_post').click(function (event) {
        ...
        var reg_nonce = $('#edit_post_nonce').val();
        ...
        var reg_post_id = $('#post_id').val();

        /**
         * AJAX URL where to send data
         * (from localize_script)
         */
        var ajax_url = ecp_reg_vars.ecp_ajax_url;

        data = {
            action: 'edit_campaign_post',
            nonce: reg_nonce,
            title: reg_title,
            content: reg_content,
        ...
        $.post(ajax_url, data, function (response) {
            ...
            if (response) {
                ...
                if (response === '1') {
                    ...
                    $('.result-message').html('Update post is complete.');
