...
<form target="paypal" action="<?php if(!$owr_donate_use_sandbox){echo 'https://www.paypal.com/cgi-bin/webscr';}else{ echo 'https://www.sandbox.paypal.com/cgi-bin/webscr';} ?>" method="post" name="myform">
    ...
    <div class="form-row align-items-end form-wrap-media">
        <div class="col">
            <div class="row align-items-center no-gutters media-label-position">
                <div class="input-wrap">
                    <input id="25Dollars" class="form-control" name="os0" type="radio" value="25.00">
                    <span class="custom-radio"></span>
                </div>
                <div class="label-wrap">
                    <label for="25Dollars">$25</label>
                </div>
            </div>
        </div>
        <div class="col">
            <div class="row align-items-center no-gutters media-label-position">
                <div class="input-wrap">
                    <input id="50Dollars" class="form-control" name="os0" type="radio" value="50.00">
                    <span class="custom-radio"></span>
                </div>
                <div class="label-wrap">
        ...
        <div class="col">
            <div class="row align-items-center no-gutters media-label-position">
                <div class="input-wrap">
                    <input id="100Dollars" class="form-control" name="os0" type="radio" value="100.00">
                    <span class="custom-radio"></span>
                </div>
                <div class="label-wrap">
        ...
        <div class="col">
            <div class="row align-items-center no-gutters media-label-position">
                <div class="input-wrap">
                    <input id="200Dollars" class="form-control" name="os0" type="radio" value="200.00">
                    <span class="custom-radio"></span>
                </div>
                <div class="label-wrap">
        ...
        <div class="col">
            <div class="row align-items-center no-gutters media-label-position">
                <div class="input-wrap">
                    <input id="otherDollars" class="form-control" name="os0" type="radio" value="Other">
                    <span class="custom-radio"></span>
                </div>
                <div class="label-wrap">
                    <label for="otherDollars">Other</label>
                </div>
            </div>
        </div>
    </div>
    <div class="section-content top-row-margin">
        What effort in this mission would you like to see your donation be contributed towards
    </div>
    <div id="missionLikeWrap" class="form-row top-row-margin">
        <div class="col-md-8">
            <select name="volunteer-trip" class="form-control" id="missionLike">
        ...
        <div class="col-md-4">
            <button id="donateButton" class="btn btn-primary owr-btn donate-btn" type="submit">Submit</button>
        </div>
    </div>
