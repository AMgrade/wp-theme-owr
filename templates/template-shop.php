...
?>
    ...
    <!-- Headline Section -->
    <div class="headline-section" style="background: url('<?php echo $owr_header_image['url']; ?>') center no-repeat; background-size: cover;"></div>
            ...
            <div class="row">
                <div class="col">
                    <div class="section-title">
                        <div class="section-title">
                            <h2>Product <span class="section-title-blue">store</span></h2>
                        </div>
                    </div>
                </div>
            </div>
